//get GeneralSummary
var GeneralSummary = function () {
    var dt;
    let initialTable = true;

    var initDatatable = function () {
        dt = $("#TbSummary").DataTable({
            searchDelay: 500,
            processing: true,
            searching: true,
            ajax: {
                url: "../GeneralSummary/GetListGSM",
                type: "POST",
                data: "",
                dataSrc: "",
            ...
            columns: [          
                ...
                {
                    data: {
                        ContExpectedTime: "cont_expected_time",
                        ExportDirection: "exportDirection",
                        InvoiceNo:"invoice_no",
                        DockingWarehouseID: "nameDockingWarehouse",
                        Cont_Stock: "cont_no",
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        console.log(data);
                        return `
                            <button onclick="ShowModalEdit('${data.date
                            }','${data.exportDirection
                            }','${data.plan
                            ...
                            <a href="javascript:;" onclick='removeItem("${data.date}");' class="btn btn-icon btn-active-light-danger btn-sm"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            initComplete: function () {
                $('#TbSummary').DataTable().buttons().container().appendTo("#dt_tools");
            }
        });
    }
    ...
    var HandleSearchDatatable = function () {
        $('#input_search').keyup(function (e) {
            $('#TbSummary').DataTable().search(e.target.value).draw();
        });
    };
